##########################################################################################################
# USAGE:
# This script uses the binary label masks ("input_labels_folder")
# and the raw images ("input_image_folder")
# to count the spots/tracks/regions of the binary label masks and creates
# the instance label masks ("output_labels_folder")
# and the raw images overlayed with the instance label masks ("output_image_folder").
...
# to the folder "number_of_tracks_extended", run this script, and get the two folders
# "labelsPredict_PP_tracks_extended", "imagesTs_tracks_extended" and the excel "number_of_tracks_extended.xlsx".
# Use the excel "number_of_tracks_extended.xlsx" and copy the values into the template excel
# "number_of_tracks_testset_extended.xlsx" (for evaluation of all testsets), then delete "number_of_tracks_extended.xlsx".
