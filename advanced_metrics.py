...
#       The summary of the validation metrics is located in ../crossval_results_folds.../postprocessed/summary.json
#       The summary of the test metrics is located in ../test_best_configuration/labelsPredict_PP/detector/summary_test.json
